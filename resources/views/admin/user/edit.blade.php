                ...
                <div class="w-full px-4">
                  ...
                  >
                    ...
                    <div class="overflow-x-auto">
                        <form class="bg-white"action="{{ url('user/edit/' . $data->id) }}" method="POST" enctype="multipart/form-data" >
                            @csrf
                            <div class="mb-2 pt-2 px-4">
                                ...
                                <div class="pt-2">
                                    <input type="text" name="name_category" value="{{ $data->name_user }}" placeholder="Nama Kategori" class="px-2 py-3 placeholder-slate-300 text-slate-600 relative bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-1/2"/>
                                </div>
                            </div> 
