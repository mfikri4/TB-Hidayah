                ...
                <div class="w-full px-4">
                  ...
                  >
                    ...
                    <div class="overflow-x-auto">
                        <form class="bg-white"action="{{ url('items/edit/' . $data->id) }}" method="POST" enctype="multipart/form-data" >
                            @csrf
                            <div class="mb-2 pt-2 px-4">
                                ...
                                <div class="pt-2">
                                    <input type="text" name="name_item" value="{{ $data->name_item }}" placeholder="Nama Barang" class="px-2 py-3 placeholder-slate-300 text-slate-600 relative bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-1/2"/>
                                </div>
                            </div> 
                            <div class="mb-2 pt-2 px-4">
                                <span class="text-sm font-semibold inline-block py-2 capitalize rounded-full text-blueGray-700">
                                ...
                                <div class="pt-2">
                                    <input type="text" name="volume" value="{{ $data->volume }}" placeholder="Volume Barang" class="px-2 py-3 placeholder-slate-300 text-slate-600 relative bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-1/2"/>
                                </div>
                            </div> 
                            <div class="mb-2 px-4">
                                <span class="text-sm font-semibold inline-block py-2 capitalize rounded-full text-blueGray-700">
                            ...
                            <div class="mb-2 pt-2 px-4">
                                ...
                                <div class="pt-2">
                                    <input type="number" name="price_purchase" value="{{ $data->price_purchase }}" placeholder="Harga Beli" class="px-2 py-3 placeholder-slate-300 text-slate-600 relative bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-1/2"/>
                                </div>
                            </div> 
                            <div class="mb-2 pt-2 px-4">
                                <span class="text-sm font-semibold inline-block py-2 capitalize rounded-full text-blueGray-700">
                                ...
                                <div class="pt-2">
                                    <input type="number" name="price_sell" value="{{ $data->price_sell }}" placeholder="Harga Jual" class="px-2 py-3 placeholder-slate-300 text-slate-600 relative bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-1/2"/>
                                </div>
                            </div> 
                            <div class="mb-2 pt-2 px-4">
                                <span class="text-sm font-semibold inline-block py-2 capitalize rounded-full text-blueGray-700">
                                ...
                                <div class="pt-2">
                                    <input type="number" name="qty_stock" value="{{ $data->qty_stock }}" placeholder="Kuantitas Stok" class="px-2 py-3 placeholder-slate-300 text-slate-600 relative bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-1/2"/>
                                </div>
                            </div> 
                            <div class="mb-2 pt-2 px-4">
                                <span class="text-sm font-semibold inline-block py-2 capitalize rounded-full text-blueGray-700">
                                ...
                                <div class="pt-2">
                                    <input type="number" name="qty_sold" value="{{ $data->qty_sold }}" placeholder="Kuantitas Terjual" class="px-2 py-3 placeholder-slate-300 text-slate-600 relative bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-1/2"/>
                                </div>
                            </div> 
                            <div class="mb-2 px-4">
                                <span class="text-sm font-semibold inline-block py-2 capitalize rounded-full text-blueGray-700">
