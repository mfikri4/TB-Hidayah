                ...
                <div class="w-full px-4">
                  ...
                  >
                    ...
                    <div class="leading-loose">
                        <form class="bg-white"action="{{ url('cart/create') }}" method="POST" enctype="multipart/form-data" class="p-10 bg-white rounded shadow-xl" >
                            @csrf
                            <div class="mb-2 pt-2 px-4 mt-2 my-6">
                                ...
                                <div class="pt-2">
                                    ...
                                    <option value="">Pilih Barang</option>
                                        ...
                                        <option value="{{$items->id}}">{{$items->name_item}} {{$items->volume}} - Rp. {{$items->price_sell}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="mb-2 pt-2 px-4">
                                ...
                                <div class="pt-2">
                                   <input class="px-2 py-2 placeholder-slate-300 text-slate-600 relative bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-1/3" id="qty_transaction" name="qty_transaction" type="number" placeholder="Jumlah Barang" aria-label="Jumlah Barang">
                                </div>
                            </div> 
