...
@section('header')
    <div class="w-1/2">
        <a class="text-blueGray-400 text-sm capitalize hidden lg:inline-block font-semibold" href="{{ url('unit') }}">              
            Satuan</a>
                ...
                <div class="w-full px-4">
                  ...
                  >
                    ...
                    <div class="overflow-x-auto">
                        <form class="bg-white"action="{{ url('unit/create') }}" method="POST" enctype="multipart/form-data" >
                            @csrf
                            <div class="mb-2 pt-2 px-4">
                                ...
                                <div class="pt-2">
                                    <input type="text" name="name_unit" placeholder="Nama Satuan" class="px-2 py-3 placeholder-slate-300 text-slate-600 relative bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-1/2"/>
                                </div>
                            </div> 
                            ...
                            <div class="mb-2 px-4 pt-2">
                                ...
                                <a href="{{ url('unit') }}" class="bg-red-500 text-white active:bg-red-600 font-bold uppercase text-sm px-4 py-2 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button"
                                    >
                                Kembali
                                </a>
                            </div>
