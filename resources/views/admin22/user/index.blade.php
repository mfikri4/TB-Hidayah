...
<h1 class="text-3xl font-bold text-black">Data Pengguna</h1>
    ...
    <div class="w-full mt-10 my-10">
        ...
        <a href="{{ url('user/create') }}" class="my-10 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mt-8">
            ...
            <table class="min-w-full bg-white">
                <thead class="bg-gray-800 text-white">
                    <tr>
                        ...
                        <th class="text-left py-3 px-3 uppercase font-semibold text-sm">Nama Pengguna</th>
                        <th class="text-left py-3 px-3 uppercase font-semibold text-sm">Email</th>
                ...
                <tr>
                    ...
                    <td class="text-left py-3 px-3"><a class="hover:text-blue-500">{{$us->name_user}}</td>
                    <td class="text-left py-3 px-3"><a class="hover:text-blue-500">{{$us->email}}</td>
                    <td class="text-left py-3 px-3"><a class="hover:text-blue-500">{{$us->name_level}}</td>
